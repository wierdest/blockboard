...
public class ColorPicker : MonoBehaviour
{
    ...
    private static void rGBToHSV( Color color, out float h, out float s, out float v )
    {
        ...
        // s = cmax == 0 ? 0 : d / cmax;
        s = cmax; // always give out max saturation
        v = cmax;
    }
    ...
    {
        var satvalGO = getGameObject( "SaturationValue" );
        var satvalKnob = getGameObject( "SaturationValue/Knob" );
        var hueGO = getGameObject( "Hue" );
        var hueKnob = getGameObject( "Hue/Knob" );
        var result = getGameObject( "Result" );
        var label = getGameObject( "Result/Label" );
        ...
        Action applySaturationValue = () => {
            ...
            if ( _color != resultColor ) {
                ...
                _color = resultColor;
                labelText.text = ColorNameConverter.FindColor(resultColor);
            }
        };
        applyHue();
    ...
    void Awake()
    {
        Color = ColorNameConverter.GetColor("rich blue");
    }
